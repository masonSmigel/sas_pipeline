...
import __trash__.maya.ui.widgets.menuBase as menuBase


def show_set_show(*args):
    import __trash__.maya.ui.set_show_ui as set_show_ui
    reload(set_show_ui)
    set_show_ui.SetShowUI.show_dialog()


def show_add_show(*args):
    import __trash__.maya.ui.add_show_ui as add_show_ui
    add_show_ui.AddShowUI.show_dialog()


def show_add_asset(*args):
    import __trash__.maya.ui.add_asset_ui as add_asset_ui
    # reload(add_asset_ui)
    add_asset_ui.AddAssetUI.show_dialog()


def show_add_sequence(*args):
    import __trash__.maya.ui.add_sequence_ui as add_sequence_ui
    # reload(add_sequence_ui)
    add_sequence_ui.AddSeqUi.show_dialog()


def show_add_shot(*args):
    import __trash__.maya.ui.add_shot_ui as add_shot_ui
    # reload(add_shot_ui)
...
def show_open_shot(*args):
    import __trash__.maya.ui.open_shot_ui as open_shot_ui
    # reload(open_shot_ui)
    open_shot_ui.OpenShotUi.show_dialog()


def save_version(*args):
    import __trash__.maya.ui.save_version_ui as save_version_ui
    reload(save_version_ui)
    save_version_ui.SaveVersionUi.show_dialog()


def quick_save(*args):
    import __trash__.maya.ui.quicksave as quicksave
    reload(quicksave)
    quicksave.QuickSave()


def publish(*args):
    import __trash__.maya.ui.publish_entity as publish_entity
    # reload(publish_entity)
    publish_entity.PublishEntityUi.show_dialog()


def import_file(*args):
    import __trash__.maya.ui.import_asset as import_asset
    # reload(import_asset)
    import_asset.ImportAssetUi.show_dialog()


def reference_file(*args):
    import __trash__.maya.ui.reference_asset as reference_asset
    # reload(reference_asset)
    reference_asset.ReferenceAssetUi.show_dialog()


def check_root_path(*args):
    import __trash__.maya.maya_pipe as maya_pipeline
    maya_pipeline.MayaPipeline.validate_root(log=True)


def set_root_path(*args):
    import __trash__.maya.ui.set_root as set_root
    reload(set_root)
    set_root.run()


def about(*args):
    import __trash__.maya.ui.about_ui as about_ui
